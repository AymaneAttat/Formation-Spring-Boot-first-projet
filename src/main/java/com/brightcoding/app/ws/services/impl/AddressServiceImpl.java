...
public class AddressServiceImpl implements AddressService {
	...
	public List<AddressDto> getAllAddresses(String email) {
		...
		List<AddressEntity> addresses = currentUser.getAdmin() == true ? (List<AddressEntity>) addressRepository.findAll() : (List<AddressEntity>) addressRepository.findByUser(currentUser);
	...
	public void deleteAddress(String addressId) {
		...
		//addressRepository.deleteAddres(addressId);
	}
